...
int ice_candidate_from_description(IceCandidate* candidate, char* description, char* end) {
  ...
  // Documentation-only TEST-NET addresses; real candidates may contain LAN IPs.
  // a=candidate:448736988 1 udp 2122260223 192.0.2.1 49250 typ host generation 0 network-id 1 network-cost 50
  // a=candidate:udpcandidate 1 udp 120 198.51.100.2 8000 typ host
